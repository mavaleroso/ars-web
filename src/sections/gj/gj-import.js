...
export default function GjImport() {
    ...
    const { mutate, isLoading } = useMutation((values) => {
        const response = globalAxios.post('general_journal/import', values, {
            headers: {
        ...
        <div>
            ...
            >
                ...
                <DialogContent dividers>
                    <Alert severity="info">Upload excel file for supporting reports based on its format. You can also download the <a href="/files/crj-sample.xlsx">sample format</a> provided.</Alert>
                    <Box
                        component="form"
                    >
                        <Grid sx={{ p: 1 }}>
