...
export const AuthProvider = (props) => {
  ...
  const initialize = async () => {
    ...
    if (isAuthenticated == true) {
      ...
      axios.defaults.headers.common['Authorization'] = `Token ${window.sessionStorage.getItem('token')}`;
      const response_user = await globalAxios.get('auth/user/', {
        headers: {
